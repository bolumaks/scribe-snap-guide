...
Before installing ScribeSnap, make sure your system meets the following requirements for each component.
...
Once you've verified all prerequisites are met, proceed to the [Installation Guide](/docs/installation) to begin setting up ScribeSnap.
